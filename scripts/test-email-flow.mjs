...
const lead = {
  ...
  stone_type: 'Granite',
  measurements: 'Test submission',
  timeline: 'ASAP',
  comments: 'Teste automatico do fluxo Gmail SMTP para St. Joseph Granite.',
  photo_names: [],
};
...
console.log('Public Email API:', JSON.stringify({
...
if (!supabaseUrl || !anonKey) {
  console.log('Supabase Function: skipped, missing local Supabase URL/key.');
...
console.log('Supabase Email Function:', JSON.stringify({
